...
const PromotSection = () => {
    return (
        <div>
            <div className='promot-bg-image bg-right md:bg-none max-w-[1536px] mx-auto lg:h-96 mt-20 p-10 rounded-md '>
            ...
            <div className='promot-bg-image2 max-w-[1536px] mx-auto lg:h-full mt-20 p-10 flex justify-end rounded-md '>
                <div className='bg-black/95 lg:w-2/6 text-white p-10 rounded-md '>
